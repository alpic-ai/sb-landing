...
export function SBSocial() {
  ...
  const logos: Logo[] = [
    ...
    { kind: "img", name: "Touchstream", src: "/assets/customer-logos/touchstream.webp", h: PNG_H },
    { kind: "img", name: "Awaze", src: "/assets/customer-logos/awaze.webp", h: PNG_H },
    { kind: "img", name: "Listo", src: "/assets/customer-logos/listo.webp", h: PNG_H },
    { kind: "img", name: "Alpic", src: "/assets/customer-logos/alpic.webp", h: PNG_H },
    { kind: "img", name: "Cottages.com", src: "/assets/customer-logos/cottages.webp", h: PNG_H },
    { kind: "img", name: "Drio", src: "/assets/customer-logos/drio.webp", h: PNG_H },
    { kind: "icon", name: "OTseek", src: "/assets/customer-logos/otseek.webp", h: 30 },
    { kind: "text", name: "OLX" },
