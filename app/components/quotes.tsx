...
export function SBQuotes({ quotesVariant = 'cards' }: { quotesVariant?: QuotesVariant } = {}) {
  const quotes: Quote[] = [
    { q: "In the past 24 hours I went from the template repo to three production-grade demos for our partners. Three. The way you've structured the Skybridge template is beautiful — extremely easy to leverage with Claude Opus and Codex.", who: "Asad Iqbal", where: "CTO · Noodle Seed", photo: "/assets/people/asad.webp" },
    { q: "Skybridge's typed bridge between server tools and React widgets is the killer feature. useToolInfo<\"my_tool\">() knows exactly what our handler returns — server-side schema changes show up instantly as typecheck errors in the widget. Building MCP apps finally feels like building normal full-stack apps.", who: "Meir Kadosh", where: "AI Engineer · Brightdata", photo: "/assets/people/meir.webp" },
    { q: "Skybridge gave us a single typed runtime for both server tools and React widgets — same TS types, hot-reload, and one deploy step into Claude and ChatGPT. It's the first MCP framework that actually feels production-grade.", who: "Stefan Lederer", where: "CEO · Bitmovin", photo: "/assets/people/stefan.webp" },
    { q: "Skybridge was the obvious pick for our MCP stack. Even on the server side, where we're not yet using app view features, one cohesive runtime beats fragmenting our codebase across SDKs. And I've never seen a team ship fixes this fast.", who: "Axel Fournier", where: "Founding Engineer · Pletor", photo: "/assets/people/axel.webp" },
    { q: "Alpic and Skybridge made spinning up the Career Coach remarkably smooth. The MCP integration was clean, deployment was fast, and the developer experience was top-notch. Highly recommend their team!", who: "Adam M.", where: "CTO · Invirtus", photo: "/assets/people/adam.webp" },
    { q: "What sold us on Skybridge was how customizable the framework is, and how effective the type-safety is between the server and the frontend.", who: "Pierre-Loic de Schaetzen", where: "Software Engineer · Chift", photo: "/assets/people/pierre-loic.webp" },
  ];
